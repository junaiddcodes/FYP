  ...
  return (
    <div className="page-container-user">
      ...
      <div className="d-flex justify-content-between">
        <h2 className="mt-3">Today's entries</h2>
        <Button
          onClick={() => {
            setModalOpen(true);
          }}
      ...
      <div className="modal-container">
        ...
        >
          <div className="modal-inner w-75 d-flex flex-column">
            ...
            <form onSubmit={handleSubmit(waterValidationForm)} className="d-flex flex-column">
              <div className="mb-3">
                <TextField
          ...
          <div class="table-wrapper-scroll-y my-custom-scrollbar">
            <table className="table">
              ...
              <tbody>
                {waterData.length == 0 ? (
                  <tr>
                    <td>There are no entries for Today</td>
                  </tr>
                ) : (
                            ...
                            <div className="modal-container">
                              ...
                              >
                                <div className="modal-inner w-75 d-flex flex-column">
                                  ...
                                  <h3>Are you sure you want to delete this water entry?</h3>
