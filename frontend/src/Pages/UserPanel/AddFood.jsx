  ...
  const updateForm = (data) => {
    if (!value) {
      ...
      var mealPost = {
        ...
        food_calories: (data.food_weight_selected / value.food_weight) * value.food_calories,
        food_proteins: (data.food_weight_selected / value.food_weight) * value.food_proteins,
        food_carbs: (data.food_weight_selected / value.food_weight) * value.food_carbs,
        food_fats: (data.food_weight_selected / value.food_weight) * value.food_fats,
        ...
        <div className="d-flex flex-column">
          <div className="d-flex">
            <div className="d-flex w-50 flex-column">
              <h4>Calories Gained: {currentCalorie?.food_calories} calories</h4>
              <h4>Calories Burnt: {Math.floor(calorieBurn.excercise_calories)} calories</h4>
              <h4>Calorie Goal: {Math.floor(userDetails?.calorie_goal)} calories</h4>
            </div>
          ...
          <div className="modal-inner w-75 d-flex flex-column">
            ...
            <form onSubmit={handleSubmit(submitForm)} className="d-flex flex-column">
              ...
              <div className="mt-3 w-100">
                {value ? <p>Enter the weight of food Taken (in grams)</p> : null}
                <TextField
                  type="number"
                  id="demo-simple-select-2"
                  className="w-100"
                  ...
                  mealData.map((e, index) => {
                    return (
                      <tr key={index}>
                        ...
                        <td>{e.food_calories} calories</td>
                                    ...
                                    >
                                      ...
                                      <div className="mt-3 w-100">
                                        <TextField
                                          ...
                                          variant="outlined"
                                          name="food_weight_selected"
                                          defaultValue={editData.food_weight_selected}
                                          {...register("food_weight_selected")}
                                          placeholder="Enter weight in grams"
                                          InputLabelProps={{
                                            style: { color: "#777" },
