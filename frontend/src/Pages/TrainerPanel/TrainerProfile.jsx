  ...
  return (
    <div className='page-container-gym'>
      ...
      {isListed == 'default' ? null : isListed == 'not-listed' ? (
        ...
        <div className='gym-box mt-3 d-flex flex-column justify-content-start'>
          <h4>
            Payment Confirmed. Rock and Roll you are now available for our users
          </h4>
        </div>
      ) : isListed == 'listed' ? (
        <div className='gym-box mt-3 d-flex flex-column justify-content-start'>
          <h4>
            You have been approved by admin. To become a trainer you need to pay
            one time fee of Rs 1000.
          </h4>
          <div>
          ...
          <div className='gym-box mt-3 d-flex flex-column align-items-left'>
            ...
            >
              <div className='input-text d-flex flex-column'>
                ...
                <label className='m-3 mb-1'>
                  Enter the company you are currently working at
                </label>
                <input
                  type='text'
                  id=''
